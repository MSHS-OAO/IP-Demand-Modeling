...
for (i in 1:ncol(census_monthly_comp_cast)) {
  data_type[i] <- class(census_monthly_comp_cast[ , i])
  
}

start_adc_col <- which(data_type == "numeric")[1]
...
## MSB
*MSB IP Epic go-live occurred in September 2019. Year-to-year comparisons not available prior to this time period.*
