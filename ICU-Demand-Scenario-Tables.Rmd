...
# knitr::opts_knit$set(root.dir = user_directory)
```
...
covid_ip_days_df_raw <- read.csv(paste0(user_directory, "/DataMart/COVID_IP_PATIENT_DAYS_DETAIL_202005121020.csv"), stringsAsFactors = FALSE, na = c("", "NA"))
