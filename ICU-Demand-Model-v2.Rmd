...
covid_census_project <- function(site) {
  ...
  column_spec(column = c(1:6), background = "inherit", color = "inherit") %>%
  # row_spec(row = 0, background = "#221f72", color = "white") %>%
  add_header_above(c("COVID-19 Peak Critical Care Census" = 4, "COVID-19 Critical Care Census Scenarios" = 2), background = c(sinai_colors[1], sinai_colors[2]), color = "white", line = FALSE)
}
...
adm_prob_kable <- kable(avg_prob_admit, format = "html", escape = FALSE, align = "c", digits = 1,
