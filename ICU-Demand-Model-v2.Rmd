...
covid_ip_days_df_raw <- read.csv(paste0(user_directory, "/DataMart/COVID_IP_PATIENT_DAYS_DETAIL_202006181550.csv"), stringsAsFactors = FALSE, na = c("", "NA"))
...
dm_covid_days_df <- dm_covid_days_df %>%
  mutate(DataMartICUDay = (IP_SITE == "MSSN" & (CENSUS_BED_TYPE %in% "Critical Care" | CENSUS_BED_TYPE %in% "Critical Care Surge")) |
         ...
         COVIDCensusDay = (PAT_DAY_INF_STATUS %in% c("COVID-19", "COVID - PUI", "SUSC COVID")))
