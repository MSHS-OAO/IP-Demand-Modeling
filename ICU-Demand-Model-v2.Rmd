...
covid_steady_state_start <- as.Date("6/1/20", format = "%m/%d/%y")
...
covid_ip_days_df_raw <- read.csv(paste0(user_directory, "/DataMart/COVID_IP_PATIENT_DAYS_DETAIL_202006241136.csv"), stringsAsFactors = FALSE, na = c("", "NA"))


# Import Epic daily COVID census
epic_covid_census_raw <- read_excel(paste0(user_directory, "/Epic COVID Repo/COVID MRN Daily Census Export 2020-06-24.xlsx"))
